...
const color_4 "Red            "
const color_5 "Pink           "
const color_6 "Yellow         "
const color_7 "Silver         "
const color_8 "Grey           "
const color_9 "Light Blue     "
const color_a "Light Green    "
const color_b "Light Cyan     "
const color_c "Light Red      "
const color_d "Light Pink     "
const color_e "Light Yellow   "
const color_f "White          "
