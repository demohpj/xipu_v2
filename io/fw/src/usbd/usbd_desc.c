...
#define USBD_PRODUCT_HS_STRING        "XiPC Storage v2" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "XiPC Storage v2" /* Add your product Full Speed string */
